package io.github.leralix.extrade.map.commands.subcommands;
...
public class UpdateTraderCommand extends SubCommand {
    @Override
    ...
    public void perform(CommandSender commandSender, String[] strings) {
        ExoticTradeMapCommon.getPlugin().updateDynmap();
